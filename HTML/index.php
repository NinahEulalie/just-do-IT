...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#about">Mon profil</a></li>
              <li class="scroll-to-section"><a href="#services">Découvrir</a></li>
              <li class="scroll-to-section"><a href="#portfolio">Utilisateurs</a></li>
              <li class="scroll-to-section"><a href="../CSS/forum.css">Déconnexion</a></li> 
              <!--<li class="scroll-to-section"><a href="#contact">Contact Us</a></li>  -->
              <li class="scroll-to-section"><div class="main-red-button-hover"><a href="../login/test1/forum.php">Questions</a></div></li> 
            ...
            <div class="col-lg-6 align-self-center">
              <div class="owl-carousel owl-banner">
                <div class="item header-text">
                  <h6>Bienvenue sur notre plateforme!</h6>
                  <h2>Notre <em>Stack overflow</em> pour <span>les étudiants de l'ENI</span></h2>
                ...
                <div class="item header-text">
                  <h6>Une échange en ligne</h6>
                  <h2>Notre <em>e-fan'App</em> pour <span>les étudiants de l'ENI</span></h2>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus, quas.</p>
                  <div class="down-buttons">
                    <!-- <div class="main-blue-button-hover">
                ...
                <div class="item header-text">
                  <h6>Entraide entre les étudiants</h6>
                  <h2>Notre <em>plateforme</em> pour <span>les étudiants de l'ENI</span></h2>
  ...
  <div id="services" class="our-services section">
    <div class="services-right-dec">
      <img src="../assets/assets/images/services-left-dec.png" alt="">
    </div>
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h2>voici les <em>Tags</em> que vous pouvez  <span>Chercher</span></h2>
            <span>explorer!</span>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-carousel owl-services">
            <div class="item">
              <h4>JavaScript</h4>
              <div class="icon"><img src="../assets/assets/images/service-icon-01.png" alt=""></div>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, dolores.</p>
            </div>
            <div class="item">
              <h4>Langage C</h4>
              <div class="icon"><img src="../assets/assets/images/service-icon-02.png" alt=""></div>
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perferendis, fugit!</p>
            </div>
            <div class="item">
              <h4>HTML/CSS</h4>
              <div class="icon"><img src="../assets/assets/images/service-icon-03.png" alt=""></div>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, error.</p>
            </div>
            <div class="item">
              <h4>Python</h4>
              <div class="icon"><img src="../assets/assets/images/service-icon-04.png" alt=""></div>
            ...
            <div class="item">
              <h4>Python</h4>
              <div class="icon"><img src="../assets/assets/images/service-icon-04.png" alt=""></div>
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quo, impedit.</p>
            </div>
            <div class="item">
              <h4>JavaScript</h4>
              <div class="icon"><img src="../assets/assets/images/service-icon-01.png" alt=""></div>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="../assets/assets/images/about-left-image.png" alt="Two Girls working together">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
            <h2>Voici votre <span>Profil</span></h2>
  ...
  <div id="portfolio" class="our-portfolio section">
    <div class="portfolio-left-dec">
      <img src="../assets/assets/images/portfolio-left-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-carousel owl-portfolio">
            <div class="item">
              <div class="thumb">
                <img src="../assets/assets/images/portfolio-01.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a rel="sponsored" href="https://templatemo.com/tm-564-plot-listing" target="_parent"><h4>Nom:</h4></a>
                    <span>Matricule</span>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="thumb">
                <img src="../assets/assets/images/portfolio-02.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Nom</h4></a>
                    <span>Matricule</span>
            ...
            <div class="item">
              <div class="thumb">
                ...
                <div class="hover-effect">
                  <div class="inner-content">
                    <a rel="sponsored" href="https://templatemo.com/tm-562-space-dynamic" target="_parent"><h4>Nom</h4></a>
                    <span>Matricule</span>
                  </div>
                </div>
              </div>
  ...
  <div class="footer-dec">
    <img src="../assets/assets/images/footer-dec.png" alt="">
  </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="about footer-item">
            <div class="logo">
              <a href="#"><img src="../assets/assets/images/logo.png" alt="Onix Digital TemplateMo"></a>
            </div>
        ...
        <div class="col-lg-3">
          <div class="community footer-item">
            <h4>Infoline</h4>
            <ul>
              <li><a href="#">a.etudiant.eni@gmail.com</a></li>
              <li><a href="#">020 75 508 01</a></li>
              <li><a href="#">Ecole Nationale d'Informatique (ENI) Fianarantsoa</a></li>
        ...
        <div class="col-lg-12">
          <div class="copyright">
            ...
            <br>
            Lorem, ipsum. <a rel="nofollow" href="https://templatemo.com" title="free CSS templates">Lorem.</a></p>
          </div>
        </div>
      </div>
    </div>
